...
class App extends Component {
  ...
  componentDidMount() {
    ...
    var galeria_marcador = document.getElementById("galeria").offsetTop;
    ...
    window.addEventListener('scroll', function (e) {
      ...
      } else if (mainScroll > piso_cinco_duelo && mainScroll < galeria_marcador) {
        parent.setState({
  ...
  render() {
    ...
    if (this.state.active == 'piso_uno_creacion') {
      ...
      tooltip = <Tooltip marcadores={marcadores} titulo="Piso 2: lugar de información y consulta" contenido="El Museo tendrá su propio centro de documentación abierto al público con acceso a libros, revistas, objetos, fotografías y documentos; los documentos del archivo serán la fuente primaria para el estudio de la historia reciente de Colombia, guardando las debidas reservas de Ley." />
      ...
      var marcadores = [
        ...
        {
          nombre: 'sala 1 (blackbox)',
          color: 'rgb(161,239,85)'
        },
        {
          nombre: 'sala 2',
          color: 'rgb(239,85,187)'
        },
        {
      ...
      tooltip = <Tooltip marcadores={marcadores} titulo="Piso 3: lugar de expresión, creación, y exposición artística y cultural" contenido="El museo, como centro cultural contemporáneo, contará con espacios para la creación y exhibición de diversas manifestaciones artísticas: teatro, cine, artes plásticas, música, además de propuestas comunicativas como radio, creación de humanidades digitales, y videos entre muchas otras." />
      ...
      tooltip = <Tooltip marcadores={marcadores} titulo="Piso 4: lugar de expresión, creación, y exposición artística y cultural" contenido="El museo, como centro cultural contemporáneo, contará con espacios para la creación y exhibición de diversas manifestaciones artísticas: teatro, cine, artes plásticas, música, además de propuestas comunicativas como radio, creación de humanidades digitales, y videos entre muchas otras." />
    } else if (this.state.active == 'piso_cinco_duelo') {
      var marcadores = [
        {
          nombre: 'lugar de duelo',
          color: 'rgb(239,85,187)'
        }
      ]
      tooltip = <Tooltip marcadores={marcadores} titulo="Lugar de Duelo" contenido="El respeto, amor y solidaridad ha movilizado a las víctimas y sectores de la sociedad a mantener viva la memoria de lo irremplazable y la ausencia siempre presente de quien han perdido a su seres queridos. Este espacio nos ayuda a la apropiación e identificación con quienes han sido afectados por la violencia y el conflicto, en un ambiente de reflexión íntima y homenaje." />
    }
    return (
      <div className="App">
